#ifndef __CXXU_VISIT_VARIANT_H__
#define __CXXU_VISIT_VARIANT_H__
...
#include <cxxu/function_signature.hpp>
...
auto visit_variant(Variant const& variant, Function1 function1, BOOST_RV_REF(Functions)... functions)
...
#endif // __CXXU_VISIT_VARIANT_H__
