...
#ifndef __CXXU_VARIANT_MPL_H__
#define __CXXU_VARIANT_MPL_H__
...
namespace detail
{
  ...
  <
    ...
    typename... Args
   >
  struct variant_max_size_helper;
  ...
  <
    ...
    typename SoFar
  >
  struct variant_max_size_helper<Size, SoFar>
  {
  ...
  <
    ...
    typename... Args
  >
  struct variant_max_size_helper<Size, SoFar, Next, Args...>
  {
    private:
    typedef typename std::conditional
    <
      (Size<Next>::value > Size<SoFar>::value),
      variant_max_size_helper<Size, Next, Args...>,
      variant_max_size_helper<Size, SoFar, Args...>
    >::type m_next;
...
<
  ...
  typename... Args
>
struct variant_max_size<Size, First, Args...>
{
  private:
  typedef decltype(Size<First>::value) m_size_type;
  typedef detail::variant_max_size_helper
  <
    Size,
    First,
    Args...
