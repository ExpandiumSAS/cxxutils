...
#ifndef __CXXU_VARIANT_H__
#define __CXXU_VARIANT_H__
...
class variant
{
  ...
  struct do_visit
  {
    ...
    )
    {
      ...
      assert((which == 0 || which > 0) && which < sizeof...(AllTypes));
  ...
  union
  {
    ...
    typename variant_max_size<Alignof, First, Types...>::type m_align;
  };
