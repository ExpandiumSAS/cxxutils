...
public:
    ...
    // of 2, elements.
    explicit spsc_queue(size_t maxSize = 15)
...
private:
    ...
    struct ReentrantGuard
    {
            ...
            : inSection(_inSection)
        {
            assert(!inSection);
            if (inSection) {
                throw std::runtime_error("spsc_queue does not support enqueuing or dequeuing elements from other elements' ctors and dtors");
            }
